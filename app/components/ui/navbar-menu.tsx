	...
	return (
		<div onMouseEnter={() => setActive(item)} className="relative ">
			<motion.p
				...
				className="cursor-pointer hover:opacity-[0.9] text-white flex items-center gap-2"
			>
				{icon}
				{item}
			</motion.p>
					...
					{active === item && (
						<div className="absolute top-[calc(100%_+_1.5rem)] left-1/2 transform -translate-x-1/2 pt-4">
							<motion.div
								...
								className="bg-black-100 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/[0.2] shadow-xl"
							>
								<motion.div
